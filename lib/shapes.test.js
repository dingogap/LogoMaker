// Logo Test Code to be run using Jest
const Circle = require('./circle.js');
const Square = require('./square.js');
const Triangle = require('./triangle.js');

// Checks to see that the output from the render method produces the expectd output - the code to render the circle logo
describe('Circle', () => {
...
// Checks to see that the output from the render method produces the expectd output - the code to render the square logo
describe('Square', () => {
...
// Checks to see that the output from the render method produces the expected output - the code to render the triangle logo
describe('Triangle', () => {
